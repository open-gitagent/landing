    ...
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border bg-background/90 backdrop-blur-sm">
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 sm:px-6 gap-3">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <span className="sketch-border rounded-full px-2 py-0.5 text-[10px] text-muted-foreground font-body">
            v1.5.0
          </span>
        </div>
        ...
        <div className="hidden md:flex items-center gap-3 shrink-0 ml-auto">
          <a
            href="/docs"
            className="text-xs sketch-border rounded-md px-3 py-1.5 bg-primary text-primary-foreground hover:opacity-90 transition-opacity font-body font-medium"
          >
            Docs
          </a>
          <a
            ...
            className="text-xs sketch-border rounded-md px-3 py-1.5 text-foreground hover:bg-accent transition-colors font-body inline-flex items-center gap-1.5"
          >
            ...
            <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
              ...
              <SheetContent side="left" className="w-64 p-0 bg-background border-r border-border">
                <div className="flex items-center gap-2 px-4 py-4 border-b border-border">
                  <span className="font-heading font-semibold text-sm"><span className="text-primary">Git</span><span className="text-foreground">Agent</span></span>
                  <span className="text-[10px] text-muted-foreground font-body ml-1">docs</span>
                </div>
