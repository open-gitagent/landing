...
import { ArrowRight, FileText, Shield, Settings, Cpu, CheckCircle2, Terminal, Lightbulb, Split, Play } from "lucide-react";
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <motion.div initial={{ opacity: 0, y: 8 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-10">
          ...
          <p className="text-[12px] text-muted-foreground font-body leading-relaxed max-w-2xl mb-3">
            ...
            converts the <code className="text-primary text-[11px]">/</code> separator to a{" "}
            <code className="text-primary text-[11px]">:</code> — keeping both the provider and the model id:
          </p>
