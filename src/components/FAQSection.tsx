...
const faqs = [
  ...
  {
    question: "What makes OpenGAP a git-native AI agent framework?",
    answer:
  ...
  {
    question: "How is OpenGAP different from other AI agent frameworks?",
    answer:
      "Most agent frameworks lock you into a single runtime or vendor. OpenGAP is framework-agnostic: define your agent once, then export to Claude Code, OpenAI Agents SDK, CrewAI, Lyzr, OpenClaw, Nanobot, or a raw system prompt. Your agent definition lives in git, not in a vendor's cloud.",
  },
  {
    question: "Is OpenGAP an open standard?",
    answer:
  ...
  },
  {
    ...
    answer:
      'Install the CLI with "npm install -g @open-gitagent/opengap", then run "opengap init --template standard" to scaffold an agent repo. Edit agent.yaml, SOUL.md, and SKILL.md to define your agent. Validate with "opengap validate", then run or export with "opengap run" or "opengap export".',
  },
];
      ...
      <div className="mx-auto max-w-3xl">
        ...
        >
          ...
          <p className="text-sm text-muted-foreground font-body">
            Common questions about the OpenGAP open AI agent standard.
          </p>
        </motion.div>
